...
public final class CameraManager2 {
  ...
  private static CameraManager2 cameraManager;
  ...
  public static void init(Context context) {
    if (cameraManager == null) {
      cameraManager = new CameraManager2(context);
    }
  }
   ...
   */
  public static CameraManager2 get() {
  ...
  public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data, int width, int height) {
    ...
    switch (previewFormat) {
      ...
      case PixelFormat.YCbCr_422_SP:
    	 // Log.d("재미난", Integer.toString(width)+","+Integer.toString(height)+":"+data.length+"length,"+rect.left+"left,"+rect.top+"top,"
    		//      	 +rect.width()+"rectWidth,"+rect.height()+"height");  
