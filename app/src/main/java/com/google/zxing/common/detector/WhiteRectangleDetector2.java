 ...
 */
public final class WhiteRectangleDetector2 {
   ...
   */
  public WhiteRectangleDetector2(BitMatrix image) throws NotFoundException {
    this.image = image;
   ...
   * @throws NotFoundException if image is too small
   */
  public WhiteRectangleDetector2(BitMatrix image, int initSize, int x, int y) throws NotFoundException {
    this.image = image;
    height = image.getHeight();
    width = image.getWidth();
