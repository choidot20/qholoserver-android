...
public final class Detector {
  ...
  public DetectorResult detect() throws NotFoundException {
    ...
    //////////////////////////////////////////
    Log.e("rectangleDetector->", "pointA:" + cornerPoints[0] + "  pointB:" + cornerPoints[1] + "  pointC:" + cornerPoints[2] + "  pointD:" + cornerPoints[3]);
    //////////////////////////////////////////////////
    ...
    if (maybeTopLeft == null || bottomLeft == null || maybeBottomRight == null) {
      Log.e("Detector()", " Not found 3 Point"); //KYT
      throw NotFoundException.getNotFoundInstance(); //KYT remove
